...
# data/conjunction_results/conj_parcels_thresh1.645_20-Jul-2021

# Path to your volume of parcels
# PARCEL_DIR = PROJECT_DIR + 'parcels/langloc_resampled_parcels_22-Sep-2020/'
PARCEL_DIR = PROJECT_DIR + 'data/conjunction_results/conj_parcels_thresh1.645_20-Jul-2021/'
# Path to where you want to save the image
IMG_PATH = PROJECT_DIR + 'images/'
IMG_NAME = 'conj_1.645_072021_parcels.pdf'
# Full path to parcel volume with filename
# PARCEL_VOL = PARCEL_DIR + 'LangLoc_resampled_zthresh3.090232_4voxSpacing_probability_map_thresh2subjs_smoothed_parcels_sig.nii.gz'
PARCEL_VOL = PARCEL_DIR + 'Conjunction_at_thresh1.645_probability_map_thresh2subjs_smoothed_parcels_sig.nii.gz'
