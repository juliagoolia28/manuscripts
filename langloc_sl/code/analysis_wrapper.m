...
opts.PROJECT_DIR = '/Users/julie/Library/CloudStorage/Box-Box/My_Collaborations/fMRI_langlocssl/data/';
opts.PARCEL_DIR = [opts.PROJECT_DIR 'task_parcels_7.2/langlocs_parcels_thresh3.09_09-Oct-2020/'];
opts.PARCEL_FILE = [opts.PARCEL_DIR 'langloc_thresh3.09_probability_map_thresh2subjs_smoothed_parcels_sig.nii.gz'];

opts.SUBJ_DEFINE_DATA_DIR = [opts.PROJECT_DIR 'input_data/langloc_nosmoothing_zstat_2022/'];
opts.SUBJ_MEASURE_DATA_DIR = [opts.PROJECT_DIR 'input_data/language_localizer_unsmoothed/'];

opts.RESULTS_DIR = [opts.PROJECT_DIR 'froi_unsmoothed/'];
if ~exist(opts.RESULTS_DIR,'dir')
    mkdir(opts.RESULTS_DIR)
end

% Conditions to measure
opts.COND = 'langloc_contrast';
opts.SUBJ_IDS = 1:22;
...
opts.PROJECT_DIR = '/Users/julie/Library/CloudStorage/Box-Box/My_Collaborations/fMRI_langlocssl/';
opts.PARCEL_DIR = [opts.PROJECT_DIR 'data/task_parcels_7.2/langlocs_parcels_thresh3.09_09-Oct-2020/'];
opts.PARCEL_FILE = [opts.PARCEL_DIR 'langloc_thresh3.09_probability_map_thresh2subjs_smoothed_parcels_sig.nii.gz'];
 
opts.TASK1_DIR = [opts.PROJECT_DIR 'data/input_data/langloc_nosmoothing_copes/'];
opts.TASK2_DIR = [opts.PROJECT_DIR 'data/input_data/asl_nosmoothing_copes/relabeled/'];
opts.MASK1_DIR = [opts.PROJECT_DIR 'data/input_data/langloc_nosmoothing_copes/'];
opts.MASK2_DIR = [opts.PROJECT_DIR 'data/input_data/asl_nosmoothing_copes/relabeled/'];
